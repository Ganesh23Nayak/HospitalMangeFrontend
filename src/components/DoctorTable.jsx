...
const DoctorTable = (userid) => {
	...
	const fetchDataFromBackend = () => {
		Axios.post(`${import.meta.env.VITE_API_URL}/getappointments`, {doctId}) // Adjust the endpoint as per your backend API
			.then((response) => {
	...
	const handleDelete = (id) => {
		if (window.confirm('Are you sure you want to delete this appointment?')) {
			...
			Axios.post(`${import.meta.env.VITE_API_URL}/cancelappointment`, {appointmentId: id})
				.then((response) => {
	...
	const handleAccept = (id) => {
		...
		if (window.confirm('Are you sure you want to accept this appointment?')) {
			Axios.post(`${import.meta.env.VITE_API_URL}/acceptappointment`, {appointmentId: id})
				.then((response) => {
					if (response.data.success) {
	...
	const handleDone = (id) => {
		...
		if (window.confirm('Done with this appointment?')) {
			Axios.post(`${import.meta.env.VITE_API_URL}/doneappointment`, {appointmentId: id})
				.then((response) => {
					if (response.data.success) {
						console.log('Appointment accepted successfully!');
						const updatedTableData = [...tableData[activeTab]];

...
const PatientDashBoard = (userid) => {
	...
	const fetchAppointments = async () => {
		try {
			const response = await Axios.post(`${import.meta.env.VITE_API_URL}/getpatientappointments`, {id});
	...
	// 			const response = await Axios.delete('${import.meta.env.VITE_API_URL}/deleteAppointment', {data: {appointmentId: idx}});
	...
	const handleDelete = async (idx) => {
		...
		if (window.confirm('Are you sure you want to delete this appointment?')) {
			try {
				// Send a request to the backend to delete the appointment
				const response = await Axios.delete(`${import.meta.env.VITE_API_URL}/deleteAppointment`, {
